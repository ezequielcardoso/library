...
public class BookDaoImpl extends BaseDaoImpl<Book> implements BookDao {
	...
	public List<Book> selectBooks(final BookView bookView) {
		...
		if (bookView.getPressName() != null
				&& !"".equals(bookView.getPressName())) {
			whereSub.append(" and t_pr.pressName like (:press) ");
		}
		if (bookView.getLocation() != null
				&& !"".equals(bookView.getLocation())) {
		...
		if (bookView.getSearchBookId() != null
				&& !"".equals(bookView.getSearchBookId())) {
			whereSub.append(" and b.searchBookId like (:searchBookId) ");
		}
		if (bookView.getSpeciesId() != null
				&& !"".equals(bookView.getSpeciesId())) {
			whereSub.append(" and b.speciesId like (:speciesId) ");
		}
		if (bookView.getFirstCategoryName() != null
				&& !"".equals(bookView.getFirstCategoryName())) {
			whereSub.append(" and t_fc.itemName like (:firstCategory) ");
		}
		if (bookView.getSecondCategoryName() != null
				&& !"".equals(bookView.getSecondCategoryName())) {
		...
		if (bookView.getOperator() != null
				&& !"".equals(bookView.getOperator())) {
			whereSub.append(" and b.operator like (:operator) ");
		}
		if (bookView.getBookStateName() != null
				&& !"".equals(bookView.getBookStateName())) {
		...
		if (bookView.getStoreDate() != null
				&& bookView.getEndStoreDate() == null) {
		...
		if (bookView.getOrderDate() != null
				&& bookView.getEndOrderDate() == null) {
		...
		HibernateCallback callback_ = new HibernateCallback() {
			...
			public Object doInHibernate(Session session)
				...
				if (bookView.getSpell() != null
						&& !"".equals(bookView.getSpell())) {
				...
				if (bookView.getBookNo() != null
						&& !"".equals(bookView.getBookNo())) {
				...
				if (bookView.getFirstCategoryName() != null
						&& !"".equals(bookView.getFirstCategoryName())) {
					temp = "%"
							+ bookView.getFirstCategoryName().replace(" ", "%")
							+ "%";
				...
				if (bookView.getBookStateName() != null
						&& !"".equals(bookView.getBookStateName())) {
					query.setParameter("bookStateName",
							bookView.getBookStateName());
				}
				if (bookView.getEmailNo() != null
						&& !"".equals(bookView.getEmailNo())) {
					temp = "%" + bookView.getEmailNo().replace(" ", "%") + "%";
					query.setParameter("emailNo", temp);
				}
				if (bookView.getISSN() != null
						&& !"".equals(bookView.getISSN())) {
				...
				if (bookView.getStoreDate() == null
						&& bookView.getEndStoreDate() != null) {
					query.setParameter("endStoreDate",
							bookView.getEndStoreDate());
				}
				if (bookView.getStoreDate() != null
						&& bookView.getEndStoreDate() != null) {
					query.setParameter("storeDate", bookView.getStoreDate());
				...
				if (bookView.getOrderDate() == null
						&& bookView.getEndOrderDate() != null) {
					query.setParameter("endOrderDate",
							bookView.getEndOrderDate());
				}
				if (bookView.getOrderDate() != null
						&& bookView.getEndOrderDate() != null) {
					query.setParameter("orderDate", bookView.getOrderDate());
		...
		HibernateCallback callback = new HibernateCallback() {
			...
			public Object doInHibernate(Session session)
				...
				if (bookView != null && bookView.getIsPage()
						&& bookView.getStart() != null
						&& bookView.getLimit() != null) {
				...
				if (bookView.getTranslator() != null
						&& !"".equals(bookView.getTranslator())) {
	...
	public Book selectBookById(Long bookId) {
		...
		book = (Book) this.getHibernateTemplate().find(hql.toString(), bookId)
				.listIterator().next();
	...
	public Book selectBookByBarCode(String barCode) {
		...
		book = (Book) this.getHibernateTemplate().find(hql.toString(), barCode)
				.listIterator().next();
