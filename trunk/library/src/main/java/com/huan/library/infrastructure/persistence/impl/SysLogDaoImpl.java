...
public class SysLogDaoImpl extends BaseDaoImpl<SysLog> implements SysLogDao {
	...
	public List<SysLog> selectSysLogs(final SysLogView sysLogView) throws Exception {
...
//			查询字段
			...
			if(sysLogView.getOperateType()!=null && !"".equals(sysLogView.getOperateType())){
				whereSub.append(" and sl.operateType like (:operateType) ");
			}
			if(sysLogView.getFuncName()!=null && !"".equals(sysLogView.getFuncName())){
				whereSub.append(" and sl.funcName like (:funcName) ");
			}
			if(sysLogView.getOperatorName()!=null && !"".equals(sysLogView.getOperatorName())){
				whereSub.append(" and sl.operatorName like (:operatorName) ");
			}
			if(sysLogView.getOperator()!=null && !"".equals(sysLogView.getOperator())){
				whereSub.append(" and sl.operator like (:operator) ");
			}
			if(sysLogView.getOperateDate()!=null && sysLogView.getEndOperateDate()==null){
			...
			HibernateCallback callback = new HibernateCallback(){
				public Object doInHibernate(Session session)
					...
					if(sysLogView!=null && sysLogView.getIsPage()&&sysLogView.getStart()!=null
					...
					if(sysLogView.getOperateDate()!=null && sysLogView.getEndOperateDate()==null){
						query.setParameter("operateDate", sysLogView.getOperateDate());
					}
					if(sysLogView.getOperateDate()==null && sysLogView.getEndOperateDate()!=null){
						query.setParameter("endOperateDate", sysLogView.getEndOperateDate());
					}
					if(sysLogView.getOperateDate()!=null && sysLogView.getEndOperateDate()!=null){
						query.setParameter("operateDate", sysLogView.getOperateDate());
						query.setParameter("endOperateDate", sysLogView.getEndOperateDate());
