...
public class BorrowReturnDaoImpl extends BaseDaoImpl<BorrowReturn> implements
	...
	public List<BorrowReturn> selectBorrowReturns(
			final BorrowReturnView borrowReturnView) {
		...
		if (borrowReturnView.getReaderBarCode() != null
				&& !"".equals(borrowReturnView.getReaderBarCode())) {
			whereSub.append(" and t_r.barCode like (:readerBarCode) ");
		}
		if (borrowReturnView.getReaderName() != null
				&& !"".equals(borrowReturnView.getReaderName())) {
			whereSub.append(" and t_r.readerName like (:readerName) ");
		}
		if (borrowReturnView.getUnitName() != null
				&& !"".equals(borrowReturnView.getUnitName())) {
			whereSub.append(" and t_ru.unitName like (:unitName) ");
		}
		if (borrowReturnView.getBookBarCode() != null
				&& !"".equals(borrowReturnView.getBookBarCode())) {
			whereSub.append(" and t_b.barCode like (:barCode) ");
		}
		if (borrowReturnView.getBookName() != null
				&& !"".equals(borrowReturnView.getBookName())) {
			whereSub.append(" and t_b.bookName like (:bookName) ");
		}
		if (borrowReturnView.getFirstCategoryName() != null
				&& !"".equals(borrowReturnView.getFirstCategoryName())) {
			whereSub.append(" and t_bf.itemName like (:firstCategoryName) ");
		}
		if (borrowReturnView.getBorrowOperator() != null
				&& !"".equals(borrowReturnView.getBorrowOperator())) {
			whereSub.append(" and br.borrowOperator like (:borrowOperator) ");
		}
		if (borrowReturnView.getReturnOperator() != null
				&& !"".equals(borrowReturnView.getReturnOperator())) {
			whereSub.append(" and br.returnOperator like (:returnOperator) ");
		}
		if (borrowReturnView.getBookStateName() != null
				&& !"".equals(borrowReturnView.getBookStateName())) {
		...
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				if (borrowReturnView.getReaderBarCode() != null
						&& !"".equals(borrowReturnView.getReaderBarCode())) {
					temp = "%"
							+ borrowReturnView.getReaderBarCode().replace(" ",
									"%") + "%";
				...
				if (borrowReturnView.getReaderName() != null
						&& !"".equals(borrowReturnView.getReaderName())) {
					temp = "%"
							+ borrowReturnView.getReaderName()
									.replace(" ", "%") + "%";
				...
				if (borrowReturnView.getUnitName() != null
						&& !"".equals(borrowReturnView.getUnitName())) {
					temp = "%"
							+ borrowReturnView.getUnitName().replace(" ", "%")
							+ "%";
				...
				if (borrowReturnView.getBookBarCode() != null
						&& !"".equals(borrowReturnView.getBookBarCode())) {
					temp = "%"
							+ borrowReturnView.getBookBarCode().replace(" ",
									"%") + "%";
				...
				if (borrowReturnView.getBookName() != null
						&& !"".equals(borrowReturnView.getBookName())) {
					temp = "%"
							+ borrowReturnView.getBookName().replace(" ", "%")
							+ "%";
				...
				if (borrowReturnView.getFirstCategoryName() != null
						&& !"".equals(borrowReturnView.getFirstCategoryName())) {
					temp = "%"
							+ borrowReturnView.getFirstCategoryName().replace(
									" ", "%") + "%";
				...
				if (borrowReturnView.getBorrowOperator() != null
						&& !"".equals(borrowReturnView.getBorrowOperator())) {
					temp = "%"
							+ borrowReturnView.getBorrowOperator().replace(" ",
									"%") + "%";
				...
				if (borrowReturnView.getReturnOperator() != null
						&& !"".equals(borrowReturnView.getReturnOperator())) {
					temp = "%"
							+ borrowReturnView.getReturnOperator().replace(" ",
									"%") + "%";
				...
				if (borrowReturnView.getBookStateName() != null
						&& !"".equals(borrowReturnView.getBookStateName())) {
					temp = "%"
							+ borrowReturnView.getBookStateName().replace(" ",
									"%") + "%";
		...
		borrowReturns = (List<BorrowReturn>) getHibernateTemplate()
	...
	public BorrowReturn selectBRByBookBar(String bookBar) {
		...
		borrowReturn = (BorrowReturn) getHibernateTemplate()
				.find(sql.toString(), bookBar).listIterator().next();
	...
	public BorrowReturn selectBRByReaderBar(String readerBar) {
		...
		borrowReturn = (BorrowReturn) getHibernateTemplate()
				.find(sql.toString(), readerBar).listIterator().next();
	...
	public List<BorrowReturn> selectBorrowReturn(
		...
		HibernateCallback callback = new HibernateCallback() {
			...
			public Object doInHibernate(Session session)
				...
				if (borrowReturnView.getBookBarCode() != null
						&& !"".equals(borrowReturnView.getBookBarCode())) {
					query.setParameter("bookBarCode",
							borrowReturnView.getBookBarCode());
					query.setParameter("bookState", "BookState_JY");
				}
				if (borrowReturnView.getReaderBarCode() != null
						&& !"".equals(borrowReturnView.getReaderBarCode())) {
					query.setParameter("readerBarCode",
							borrowReturnView.getReaderBarCode());
				}
				return query.list();
			}
		};
	...
	public BorrowReturn selectBRById(Long id) {
		...
		borrowReturn = (BorrowReturn) getHibernateTemplate()
				.find(sql.toString(), id).listIterator().next();
