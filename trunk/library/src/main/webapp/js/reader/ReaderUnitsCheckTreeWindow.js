 ...
 *
 */
Library.tree.ReaderUnitsCheckTreeWindow = Ext.extend(Ext.Window, {
	...
	initComponent : function() {
		...
		Library.tree.ReaderUnitsCheckTreeWindow.superclass.initComponent.call(this);
	...
	confirmHandler : function() {
		...
		Ext.Ajax.request({
			...
			params : {
				"reader.id" : this.record.get('id'),
				"reader.readerUnits.unitId" : checkedTreeId
			},
			success : function(resp){
				this.record.set('unitId', checkedTreeId);
				this.record.set('unitName', checkedTreeText);
				this.record.commit();
			}, 
			failure : function(){
