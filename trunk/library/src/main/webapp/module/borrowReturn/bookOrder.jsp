...
<html>
	<head>
		...
		<title>图书馆管理系统</title>
		<script type="text/javascript" src="<%=path %>/js/borrowReturn/BookOrder.js"></script>
		<script type="text/javascript"
			src="<%=path %>/js/borrowReturn/BookOrderGridPanel.js"></script>
	</head>
	<body>
			...
			<tr>
				<td valign="top" height="10">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td>
											<table width="100%" border="0" align="center" cellpadding="0"
												...
												<tr>
													<td width="19%" height="25" nowrap style="text-align: left">
						...
						<tr id="yy" >
							<td height="10" valign="top">
								<table width="67%" border="0" align="left" cellpadding="1"
