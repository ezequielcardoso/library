        ...
        <td height="10" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"   class="title_border">
                  <tr>
                    <td width="19%" height="25" style="text-align:left"><strong>&nbsp;<img src="<%=path %>/images/module/cl0.gif" align="absmiddle"  >读者管理</strong></td>
                    <td width="81%" height="25"   class=body1 style="text-align:left"><img src="<%=path %>/images/module/02a.gif"  > 当前位置：读者管理 &gt;&gt;借阅证管理</td>
                  </tr>
              </table></td>
            </tr>
        </table></td>
        ...
        <td height="10" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
            <tr>
              <td height="30" class="body1">&nbsp;
                <input type="button" class="btn" onClick="window.location='cardList.html'" value="修 改">
                &nbsp;
                <input type="button" class="btn" onClick="document.getElementById('productInfor').reset();" value="重 置">
                &nbsp;
											...
											<table width="60%" border="1" align="left" cellpadding="0"
												...
												<tr>
													...
													<td width="35%" height="30" align="left" nowrap
														bgcolor="#F4F5F9">
														<input type="text" value="0803010099" disabled="disabled" />
													</td>
												</tr>
												<tr
												...
												<tr bgcolor="#FAFBFC"
													...
													<td width="35%" height="30" align="left" nowrap
														...
														<input type="text" value="0803010099" />
													</td>
												</tr>
												<tr
													onMouseOver="this.style.backgroundColor='#eff1f4';return true;"
												...
												<tr
													...
													<td width="35%" height="30" align="left" nowrap
														bgcolor="#F4F5F9">
														<input name="" type="text" value="2010-5-5"
															onClick="WdatePicker();">
													</td>
												<tr
													onMouseOver="this.style.backgroundColor='#eff1f4';return true;"
													...
													<td width="35%" height="30" align="left" nowrap
														bgcolor="#F4F5F9">
														<input name="" type="text" value="2014-2-2"
															onClick="WdatePicker();">
													</td>
												</tr>
												<tr
												...
												<tr
													...
													<td width="35%" height="30" align="left" nowrap
														...
														<input name="fileName" type="file" class="text1" size="25">
													</td>
												</tr>
