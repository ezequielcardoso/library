...
<html>
	<head>
		...
		<title>图书馆管理系统</title>
	    <script type="text/javascript" src="<%=path%>/js/system/CardLost.js"></script>
	    <script type="text/javascript" src="<%=path%>/js/combobox/flatDicComboBox.js"></script>
	    <script type="text/javascript" src="<%=path%>/js/system/CardLostFormPanel.js"></script>
	</head>
	<body>
