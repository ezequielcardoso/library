...
<html>
	<head>
		...
		<title>图书馆管理系统</title>
		<script type="text/javascript" src="<%=path %>/js/statistics/MagazineBorrowStatic.js"></script>
		<script type="text/javascript" src="<%=path %>/js/statistics/MagazineBorrowStaticGridPanel.js"></script>
	</head>
	<body>
			...
			<tr>
				<td valign="top" height="10">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													<td width="19%" height="25" align="left"
														...
														<strong>&nbsp;<img align="absmiddle"
																src="<%=path %>/images/module/cl0.gif">查询统计</strong>
													</td>
						...
						<tr id="yy">
							<td height="10" valign="top">
								<table width="46%" border="0" align="left" cellpadding="0"
									cellspacing="0" bordercolor="#ebebeb"
									borderColorLight="#ebebeb" borderColorDark="#ffffff" id="LM1">

									<TR>
										<TD width="10%" height=25 align="right" nowrap="nowrap"
									...
									<TR>
										...
										<td width="10%" align="left" nowrap>
											<input name="borrowOperator" type="text" class="input2"
												id="borrowOperator"  size="15">
										</td>
										<TD height=25 align="right" nowrap="nowrap">
											归还操作员：
										</TD>
										<td width="10%" align="left" nowrap>
											<input name="returnOperator" type="text" class="input2"
												id="returnOperator" size="15">
										</td>
										<TD height=25 align="right" nowrap="nowrap">
											期刊状态：
										</TD>
											...
											<table id="tab1" width="97%" border="1" align="center"
												...
												<tr>
													<td width="1000" height="300" align="left" valign="top">
														<div id="magazineStaticsGrid"></div>
													</td>
												</tr>
											</table>
										</td>
