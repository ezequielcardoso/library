...
<html>
	<head>
		...
		<title>图书馆管理系统</title>
		<script type="text/javascript" src="<%=path %>/js/preOrder/BookQuery.js"></script>
		<script type="text/javascript" src="<%=path %>/js/preOrder/BookQueryGridPanel.js"></script>
	</head>
	<body>
							...
							<td height="10" valign="top">
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<TR>
										...
										<TD height=25 align="left" colspan="3" nowrap class="body">
