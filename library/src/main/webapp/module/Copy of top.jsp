...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="27"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="508" height="27" background="<%=path%>/images/module/title_01.jpg">&nbsp;&nbsp;欢迎您：administrator&nbsp;&nbsp;<img src="<%=path%>/images/module/play.gif" width="16" height="17" align="absmiddle">&nbsp;<SCRIPT language=javascript>
...
document.write(getFullYear(today) +"年"  + isnMonths[today.getMonth()] +  today.getDate()+"日&nbsp;" +  isnDays[today.getDay()]);
        ...
        <td width="500" align="right" background="<%=path%>/images/module/title_03.jpg"><a href="main.htm" target="mainFrame"><img src="<%=path%>/images/module/home.gif" align="absmiddle">首页</a>&nbsp;<a href="login.html" target="_parent"><img src="<%=path%>/images/module/quit.jpg"  align="absmiddle">退出系统&nbsp;&nbsp;</a></td>
      </tr>
    </table></td>
  </tr>
</table>
