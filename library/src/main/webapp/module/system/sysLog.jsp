...
<html>
	<head>
		...
		<title>图书馆管理系统</title>
		<script type="text/javascript" src="<%=path%>/js/system/SysLog.js"></script>
		<script type="text/javascript" src="<%=path%>/js/system/SysLogGridPanel.js"></script>
	</head>
	<body>
												...
												<tr>
													<td width="19%" height="25" style="text-align: left">
														<strong>&nbsp;<img align="absmiddle"
																src="<%=path %>/images/module/cl0.gif"> 系统管理</strong>
													</td>
								  ...
								  <TR>
										...
										<TD width="8%" height=25 align="right" valign="center" nowrap class=body>
                                         ...
                                         <TD height=25 align="left" valign="top" nowrap class=body>
                                            <input name="sysLog.funcName" type="text"  id="sysLog.funcName"
												 size="15" >
										</TD>   
								  </TR>
										...
										<TD width="8%" height=25 align="right" valign="center" nowrap class=body style="padding-left:12px;">
                                         ...
                                         <TD width="10%" height=25 align="left" valign="top" nowrap class=body>
                                           <input name="sysLog.operateType" type="text"  id="sysLog.operateType"  
												 size="15" >
										</TD> 
										<TD width="8%" height=25 align="right" valign="center" nowrap class=body>
                                            操作人：
                                         ...
                                         <TD height=25 align="left" valign="top" nowrap class=body>
                                            <input name="sysLog.operator" type="text"  id="sysLog.operator" 
												 size="15" >
										</TD>   
								  </TR>
