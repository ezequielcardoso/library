...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/js/reader/ReaderType.js"></script>
		<script type="text/javascript" src="<%=path%>/js/reader/ReaderTypeGridPanel.js"></script>
	 	</head>
	<body>
