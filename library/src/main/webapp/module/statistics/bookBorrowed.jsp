...
<html>
	<head>
		...
		<title>图书馆管理系统</title>
		<script type="text/javascript" src="<%=path %>/js/statistics/BookBorrowStatic.js"></script>
		<script type="text/javascript" src="<%=path %>/js/statistics/BookBorrowStaticGridPanel.js"></script>
	</head>
	<body>
