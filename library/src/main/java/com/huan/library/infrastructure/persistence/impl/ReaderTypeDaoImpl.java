...
public class ReaderTypeDaoImpl extends BaseDaoImpl<ReaderType> implements
		ReaderTypeDao {

	public List<ReaderType> selectReaderTypes(
			final ReaderTypeView readerTypeView) {
		...
		HibernateCallback callback = new HibernateCallback() {
			...
			public Object doInHibernate(Session session)
				...
				if (readerTypeView != null && readerTypeView.getId() != null
						&& readerTypeView.getIsPage()) {
		...
		readerTypes = (List<ReaderType>) getHibernateTemplate().executeFind(
				callback);
		...
		// };
		// Long totalCount =
		// (Long)getHibernateTemplate().executeFind(callback_);
