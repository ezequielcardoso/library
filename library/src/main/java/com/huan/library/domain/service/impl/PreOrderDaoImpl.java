...
public class PreOrderDaoImpl extends BaseDaoImpl<PreOrder> implements
		PreOrderDao {
	...
	public List<PreOrder> selectPreOrders(final PreOrderView preOrderView) {
		...
		if (preOrderView.getReaderBarCode() != null
				&& !"".equals(preOrderView.getReaderBarCode())) {
			whereSub.append(" and t_r.barCode like (:readerBarCode) ");
		}
		if (preOrderView.getReaderName() != null
				&& !"".equals(preOrderView.getReaderName())) {
			whereSub.append(" and t_r.readerName like (:readerName) ");
		}
		if (preOrderView.getUnitName() != null
				&& !"".equals(preOrderView.getUnitName())) {
			whereSub.append(" and t_ru.unitName like (:unitName) ");
		}
		if (preOrderView.getBookBarCode() != null
				&& !"".equals(preOrderView.getBookBarCode())) {
			whereSub.append(" and t_b.barCode like (:barCode) ");
		}
		if (preOrderView.getBookName() != null
				&& !"".equals(preOrderView.getBookName())) {
			whereSub.append(" and t_b.bookName like (:bookName) ");
		}
		if (preOrderView.getFirstCategoryName() != null
				&& !"".equals(preOrderView.getFirstCategoryName())) {
			whereSub.append(" and t_bf.itemName like (:firstCategoryName) ");
		}
		if (preOrderView.getPreOrderDate() != null
				&& preOrderView.getEndPreOrderDate() == null) {
		...
		if (preOrderView.getPreOrderEndDate() != null
				&& preOrderView.getEndPreOrderEndDate() == null) {
		...
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				if (preOrderView.getReaderBarCode() != null
						&& !"".equals(preOrderView.getReaderBarCode())) {
					temp = "%"
							+ preOrderView.getReaderBarCode().replace(" ", "%")
							+ "%";
				...
				if (preOrderView.getBookBarCode() != null
						&& !"".equals(preOrderView.getBookBarCode())) {
					temp = "%"
							+ preOrderView.getBookBarCode().replace(" ", "%")
							+ "%";
				...
				if (preOrderView.getFirstCategoryName() != null
						&& !"".equals(preOrderView.getFirstCategoryName())) {
					temp = "%"
							+ preOrderView.getFirstCategoryName().replace(" ",
									"%") + "%";
					query.setParameter("firstCategoryName", temp);
				}
				if (preOrderView.getPreOrderDate() != null
						&& preOrderView.getEndPreOrderDate() == null) {
					query.setParameter("preOrderDate",
							preOrderView.getPreOrderDate());
				}
				if (preOrderView.getPreOrderDate() == null
						&& preOrderView.getEndPreOrderDate() != null) {
					query.setParameter("endPreOrderDate",
							preOrderView.getEndPreOrderDate());
				}
				if (preOrderView.getPreOrderDate() != null
						&& preOrderView.getEndPreOrderDate() != null) {
					query.setParameter("preOrderDate",
				...
				if (preOrderView.getPreOrderEndDate() != null
						&& preOrderView.getEndPreOrderEndDate() == null) {
					query.setParameter("preOrderEndDate",
							preOrderView.getPreOrderEndDate());
				}
				if (preOrderView.getPreOrderEndDate() == null
						&& preOrderView.getEndPreOrderEndDate() != null) {
					query.setParameter("endPreOrderEndDate",
							preOrderView.getPreOrderEndDate());
				}
				if (preOrderView.getPreOrderEndDate() != null
						&& preOrderView.getEndPreOrderEndDate() != null) {
					query.setParameter("preOrderEndDate",
							preOrderView.getPreOrderEndDate());
					query.setParameter("endPreOrderEndDate",
							preOrderView.getEndPreOrderEndDate());
				}
				return query.list();
			}
		};
		preOrders = (List<PreOrder>) getHibernateTemplate().executeFind(
				callback);
