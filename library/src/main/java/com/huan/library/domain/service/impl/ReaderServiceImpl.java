	...
	public String exportExcel(String rootDir, ReaderView readerView) throws Exception {
        ...
        try {
			...
			WritableSheet ws = ww.createSheet("读者信息", 0);
			 ...
			 ExcelOperate.addLabelToSheet(ws, 18, 1, "证件号码", ExcelStyle.getTitleStyle());
			 ExcelOperate.addLabelToSheet(ws, 19, 1, "借阅证状态", ExcelStyle.getTitleStyle());
			 
			 int count =2;
			 for(Reader reader:readers){
				    ExcelOperate.addLabelToSheet(ws, 0, count, reader.getCardNo(), ExcelStyle.getContentStyle());   
	            	ExcelOperate.addLabelToSheet(ws, 1, count, reader.getPassword(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 2, count, reader.getBarCode(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 3, count, reader.getReaderName(), ExcelStyle.getContentStyle());
	            	...
	            	ExcelOperate.addLabelToSheet(ws, 7, count, reader.getContactTel(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 8, count, reader.getLeftMoney(), ExcelStyle.getContentStyle());
	            	...
	            	ExcelOperate.addLabelToSheet(ws, 12, count, reader.getBorrowedQuantiy(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 13, count, reader.getTotalBQuantity(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 14, count, reader.getReaderDesc(), ExcelStyle.getContentStyle());
		            ExcelOperate.addLabelToSheet(ws, 15, count, reader.getReaderUnits().getUnitName(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 16, count, reader.getReaderType().getReaderCateName(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 17, count, reader.getCertificate().getItemName(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 18, count, reader.getCertificate().getItemCode(), ExcelStyle.getContentStyle());
	            	ExcelOperate.addLabelToSheet(ws, 19, count, reader.getCardState().getItemName(), ExcelStyle.getContentStyle());
	            	count++; 
			 }
